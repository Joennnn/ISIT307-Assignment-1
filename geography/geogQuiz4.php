...
<html lang="en">
    <head>
        ...
        <title>Geography Quiz Question 4</title>
    ...
    <?php 
        ...
        $quesIndex = $_SESSION['key4'] ?? ( $_SESSION['key4'] = array_rand($geogQues));
            ...
            <div class='form-container'>
                <form action='<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>' method='POST'>
                    ...
                    <div class="quesButton">
                        <button type="button" onclick="location.href = 'geogQuiz3.php'">Previous</button></br></br>
        ...
        <script>
            ...
            function finished_typing() {
                ...
                window.localStorage.setItem("geogUserInput1", finalText);
            ...
            var finalText = document.getElementsByName("ansText")[0].value = getSavedValue("geogUserInput1");
        </script>
    </body>
</html>